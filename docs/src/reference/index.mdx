...
Wrap the root of your app in a ThemeProvider. Import **ThorinGlobalStyles** and declare it as a child of **ThemeProvider**. Import **lightTheme** or **darkTheme** and pass it to the **ThemeProvider**. Add [IBM Plex Mono](https://github.com/IBM/plex) to your font stack.
